...
namespace IdentityServer.IntegrationTests.Endpoints.Introspection
{
    public class IntrospectionTests
    {
        ...
        public async Task Response_data_should_be_valid_using_single_scope()
        {
            ...
            // var values = introspectionResponse.Json.ToObject<Dictionary<string, object>>(); // TODO remove .netcore3.1
            var values = System.Text.Json.JsonSerializer.Deserialize<Dictionary<string, JsonElement>>(introspectionResponse.Json);
